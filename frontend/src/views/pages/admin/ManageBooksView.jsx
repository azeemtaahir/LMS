...
import { Search, Eye, Edit, Trash2, ChevronLeft, ChevronRight, Plus, X } from "lucide-react";
      ...
      {showAddForm ? (
        ...
        <>
          ...
          <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 p-4 rounded-xl border border-indigo-900/40 shadow-xl flex flex-col md:flex-row gap-3 items-center justify-between text-white">
            ...
            {/* Category & Status Filter Dropdowns + Add Button */}
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              <div className="flex items-center gap-2">
                <label className="text-xs font-semibold text-indigo-200">Category:</label>
                <select
