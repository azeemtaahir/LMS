  ...
  return (
    <div className="max-w-4xl mx-auto space-y-2 pb-2 select-none">
      ...
      <div className="bg-slate-900 p-3 sm:px-4 sm:py-3 rounded-xl border border-slate-800 shadow-md flex items-center justify-between text-white">
        <div>
          <h2 className="text-base font-extrabold text-white tracking-tight">Register Librarian</h2>
          <p className="text-[11px] text-slate-400 font-medium">Create staff account credentials and shift permissions for new librarian.</p>
        </div>
        <button
          type="button"
        ...
        >
          <ArrowLeft size={13} />
          <span>Back to Manage Librarians</span>
        </button>
      </div>

      {/* Form Container */}
      <form onSubmit={onSubmit} className="bg-white p-4 sm:p-5 rounded-xl border border-amber-900/10 shadow-xs space-y-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2.5 text-xs">
          {/* Librarian ID */}
          <div>
            <label className="block text-[11px] font-semibold text-stone-700 mb-0.5">Librarian ID *</label>
            <input
              type="text"
              name="librarianId"
              ...
              className="w-full px-3 py-1.5 rounded-lg border border-stone-200 bg-stone-50/50 text-xs focus:ring-2 focus:ring-[#522E1E] focus:outline-none transition"
              required
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-3 py-1.5 rounded-lg border border-stone-200 bg-stone-50/50 text-xs focus:ring-2 focus:ring-[#522E1E] focus:outline-none transition font-medium text-stone-800"
            >
          ...
          {/* Access Role */}
          <div>
            <label className="block text-[11px] font-semibold text-stone-700 mb-0.5 flex items-center gap-1">
          ...
          {/* Password */}
          <div>
            <label className="block text-[11px] font-semibold text-stone-700 mb-0.5">Password *</label>
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-1.5 rounded-lg border border-stone-200 bg-stone-50/50 text-xs focus:ring-2 focus:ring-[#522E1E] focus:outline-none transition pr-9"
                required
              />
              <button
                type="button"
        ...
        <div className="flex items-center justify-end gap-2 pt-2 border-t border-stone-100">
          <button
            type="button"
            onClick={handleCancel}
            className="px-4 py-1.5 rounded-xl border border-stone-200 text-stone-600 hover:bg-stone-50 text-xs font-semibold transition cursor-pointer"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="px-5 py-1.5 rounded-xl bg-[#2C1810] hover:bg-[#522E1E] text-white text-xs font-semibold transition shadow-sm cursor-pointer"
          >
            Register Librarian
          </button>
        </div>
